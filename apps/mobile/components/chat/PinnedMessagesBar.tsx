...
import { View, Text, TouchableOpacity, ScrollView, LayoutAnimation, Platform, UIManager, Modal, Pressable } from "react-native";
  ...
  return (
    ...
    >
      ...
      <View style={{ paddingHorizontal: 12, paddingVertical: 10, flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
        ...
        >
          <View style={{ width: 32, height: 32, borderRadius: 16, backgroundColor: "#E5F1FF", alignItems: "center", justifyContent: "center", marginRight: 10 }}>
        ...
        <View style={{ flexDirection: "row", alignItems: "center" }}>
          {remaining > 0 && (
            ...
            >
              <Text style={{ fontSize: 11, fontWeight: "700", color: isOpen ? "white" : "#666" }}>
          ...
          {!isOpen && (
            <TouchableOpacity onPress={() => onUnpin(first._id)} style={{ padding: 4 }}>
        ...
        >
          ...
          >
            <View style={{ padding: 16, borderBottomWidth: 1, borderBottomColor: "#f3f4f6", flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
              <Text style={{ fontSize: 16, fontWeight: "700", color: "#111" }}>Danh sách tin nhắn ghim</Text>
              ...
              {pinnedMessages.map((msg, index) => (
                <View
                  ...
                  style={{
                    ...
                    paddingVertical: 14,
                    borderBottomWidth: index === pinnedMessages.length - 1 ? 0 : 1,
                ...
                >
                  ...
                  >
                    <View style={{ flex: 1 }}>
                      <Text style={{ fontSize: 14, fontWeight: "700", color: "#111" }}>{msg.senderId.profile.name}</Text>
                  ...
                  <TouchableOpacity
                    ...
                    style={{ padding: 10 }}
                  >
                    <MaterialCommunityIcons name="pin-off-outline" size={20} color="#f87171" />
                  </TouchableOpacity>
                </View>
              ))}
            </ScrollView>
